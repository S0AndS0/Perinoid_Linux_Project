...
_bridge_types="${_bridge_types:-private}"
#_relay_types="${_relay_types:-}"
...
_tor_relay_control_port="${_tor_relay_control_port:-9051}"
...
_tor_service_clients="${_tor_service_clients:-$USER}"
_tor_hidden_service_addr="${_tor_hidden_service_addr:-127.0.0.1}"
_tor_or_port="${_tor_or_port:-8443}"
...
_tor_trans_port="${_tor_trans_port:-9040}"
_tor_virtual_addr_network="${_tor_virtual_addr_network:-10.192.0.0/10}"
